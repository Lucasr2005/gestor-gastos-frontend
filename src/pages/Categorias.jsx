...
function Categorias() {
  ...
  return (
    <>
      ...
      <div className=" flex  flex-1 items-center justify-between  px-4 mx-4  mb-5">
        ...
        <p className="text-center max-w-20 min-w-20">Fecha</p>
      </div>
      {gastos.map((gasto) => {
        return (
          <div
          ...
          >
            ...
            <p className=" text-center">{new Date(gasto.fecha).toISOString().split("T")[0]}</p>
          </div>
        );
      })}
    </>
